...
const EMAIL_TO = "update-me@example.com"; // TODO: Set your email here
			...
			<main id="top" className="container mx-auto px-4">
				...
				<section className="relative overflow-hidden pt-16 pb-12 md:pt-24 md:pb-20">
					...
					<div className="relative grid gap-6 md:grid-cols-[1.5fr_1fr] items-start animate-enter">
						...
						<Card id="about" className="shadow-elegant">
							<CardHeader>
							...
							<CardContent>
								<form onSubmit={handleContactSubmit} className="grid gap-4">
									...
									<p className="text-xs text-muted-foreground">
										Email will open in your mail app. Set your email in code at
										EMAIL_TO.
									</p>
								</form>
							</CardContent>
